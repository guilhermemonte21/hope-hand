...
import { ButtonShort, ButtonStyled, TextButton} from "../../components/Botao/Style";
...
export const Perfil = ({ navigation }) => {
    ...
    return (
        <Container>
            ...
            {/* Subtitullo da Ong */}
            <SubtitleStyled>Acreditamos que todos merecem a chance de viver uma vida plena e digna. Trabalhamos incansavelmente para criar oportunidades que permitam que indivíduos e comunidades superem desafios e alcancem seu potencial máximo. Através de nossas iniciativas, buscamos reduzir a desigualdade, promover a justiça social e garantir que cada pessoa tenha acesso aos recursos necessários para uma vida digna e saudável.</SubtitleStyled>
